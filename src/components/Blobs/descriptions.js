export default {
  code: `
    I started coding when i was 14 years old and i vivdly remember the excitement that accompanied me when i first opened the Swift Playgrounds app on my iPad and felt a huge world unfold as i discovered what it meant to create things with code.
  ...
  am: `
    I am a human person and i am 17 years of old. I am a pretty nerdy high school teenager from northern Mexico (Dog city, to be precise) and have strong interests in computer science, physics, and philosophy. From this it might be inferred i love intelectual travel so i dare include that i also love physical travel and bodily locomotion (running).
    I was born February the 19th 2002.
    When it comes to human languages, i am fluent in English and Spanish, some German, bit of french, and i am a beginner in Chinese.
    When it comes to computer languages, i am fluent in JS, pretty well on Python and Swift, and i am a beginner in Dart.`,
  write: `
